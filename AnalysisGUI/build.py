...
subprocess.check_call([
        ...
        "--release",
        "--strip",
        "--target-dir", "AnalysisGUI/utils",
        "--interpreter", sys.executable,
        "--out", "AnalysisGUI/utils"  # or wherever you want the .so placed
    ])
...
cython_dir = os.path.join(base_dir,  "AnalysisGUI", "utils")
...
for output in cmd.get_outputs():
    ...
    target_dir = os.path.join(base_dir,  "AnalysisGUI", "utils")
